...
namespace Manning.MyPhotoAlbum
{
    ...
    public class AlbumStorageException : Exception
    {
        ...
        public AlbumStorageException(string message) : base(message)
        {
        }

        public AlbumStorageException(string message, Exception innerException) : base(message, innerException)
        {
        }
    }
}
